...
<form  autoComplete="off"   className={classes.imgBox}  style={{   display: width<900? 'flex':null,
        alignItems: width<900? 'center':null ,flexDirection:width<900?'column':null}}   onSubmit={handleClick} >
